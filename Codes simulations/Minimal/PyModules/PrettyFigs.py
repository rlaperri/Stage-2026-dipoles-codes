...
#%%
def arrow(xy_tail, xy_head, mutation_scale=100, **kwargs):
    (x_tail, y_tail)=xy_tail
    (x_head, y_head)=xy_head
    
    return mpatches.FancyArrowPatch((x_tail, y_tail), (x_head, y_head),mutation_scale=mutation_scale,**kwargs)
#%%
def newfig(a=1,b=1,figheight=12,aspectratio=0.75,fontsize=36,**kwargs):
    rc('legend', frameon=False,fancybox=False,shadow=False,fontsize=24,loc='best')
