...
% V_lost is the volume that remains below the propeller
...
%y.h = V_tot/(2*60*60) ;   % height of water that we need in each water tank
...
% density_bacs(1.5,38,79,33,0,'bottom')
% CHANGER V_lost et remesurer 